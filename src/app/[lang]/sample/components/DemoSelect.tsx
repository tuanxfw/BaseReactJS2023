...
const DemoSelect = () => {
  const data = [
    ...
    { value: 2, name1: "Dòng 2", name2: "Row2", name3: "2" },
    { value: 3, name1: "Dòng 3", name2: "Row3", name3: "3" },
        ...
        <Row>
          ...
          >
            ...
            <CommonSelect
              ...
              datalist={data}
              columnOptions={[
                { fieldName: "name1", header: "Cột 1", width: 8 },
                { fieldName: "name2", header: "Cột 2", width: 8 },
                { fieldName: "name3", header: "Cột 3", width: 8 },
              ]}
            />
          </Col>
