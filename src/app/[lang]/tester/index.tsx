...
const TestForm = ({ closeModal }: any) => {
  return (
    <>
      <Row>
        <Col className="col-space" {...{ xxl: 8, xl: 8, lg: 8, md: 8, sm: 8, xs: 24 }}>
      ...
      <div style={{ textAlign: "right" }}>
        <CommonButton btnType="text" onClick={() => alert("Ok submíttt")} style={{ marginRight: "10px" }}>
          Submit
        </CommonButton>
