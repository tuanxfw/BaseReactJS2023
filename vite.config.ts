  ...
  return {
    resolve: {
      alias: [
        ...
        { find: '@locales', replacement: fileURLToPath(new URL('./src/locales', import.meta.url)) },
        { find: '@components', replacement: fileURLToPath(new URL('./src/components', import.meta.url)) },
        { find: '@routes', replacement: fileURLToPath(new URL('./src/routes', import.meta.url)) },
        { find: '@style', replacement: fileURLToPath(new URL('./src/style', import.meta.url)) },
    ...
    plugins: [
      ...
      Pages({
        routeStyle: "next",
        dirs: [
          { dir: "src/app", baseRoute: env.VITE_PUBLIC_URL, filePatern: "**/index.tsx" },
        ],
